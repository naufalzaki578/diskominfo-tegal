...
Route::get('/cek-status', [RegistrasiController::class, 'checkStatusForm'])->name('registrasi.status');
Route::post('/cek-status', [RegistrasiController::class, 'checkStatus'])->name('registrasi.status.check');
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/registrasi/{registrasi}/surat-pengantar', [RegistrasiController::class, 'downloadSuratPengantar'])->name('registrasi.surat');
    Route::get('/registrasi/{registrasi}/cv', [RegistrasiController::class, 'downloadCv'])->name('registrasi.cv');
});
